...
#define kref_to_xbus(k) container_of(k, struct xbus, kref)
	...
	/* PCM metrics */
	dahdi_timeval_t last_tx_sync;
	dahdi_timeval_t last_rx_sync;
...
struct xframe {
	...
	atomic_t frame_len;
	xbus_t *xbus;
	dahdi_timeval_t tv_created;
	dahdi_timeval_t tv_queued;
	dahdi_timeval_t tv_submitted;
	dahdi_timeval_t tv_received;
