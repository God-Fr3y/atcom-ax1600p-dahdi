...
static int xpp_ticker_step(struct xpp_ticker *ticker, const dahdi_timeval_t *t)
{
	unsigned long flags;
	long usec;
	bool cycled = 0;
 ...
 * algorithm.
 */
static void xpp_drift_step(xbus_t *xbus, const dahdi_timeval_t *tv)
{
	struct xpp_drift *di = &xbus->drift;
...
static void do_tick(xbus_t *xbus, const dahdi_timeval_t *tv_received)
{
